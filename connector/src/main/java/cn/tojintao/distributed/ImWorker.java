...
import static cn.tojintao.constant.ServerConstants.PORT;
import static cn.tojintao.constant.ServerConstants.nettyName;
...
public class ImWorker {
    ...
    public boolean incBalance() {
        ...
        while (true) {
            try {
                ...
                List<Instance> instances = namingService.selectInstances(nettyName, true);
    ...
    private void deleteNode() {
        ...
        try {
            namingService.deregisterInstance(nettyName, IP, PORT);
